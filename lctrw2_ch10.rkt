...
(require "make-move.rkt")
(require "attacks-defenses-v2.rkt")
...
(define test-pos (pos-from-fen "r2r2k1/pp3pp1/q3b2p/8/3n4/1P3B2/P2Q1PPP/3R1RK1 w - - 0 3"))
(define test-current-depth 3)
(define test-max-depth 5)
(define test-candidate-moves candidate-moves-attack-pinned-piece)
...
(print-moves-considered "r2r2k1/pp3pp1/q3b2p/5n2/3B4/1P3B2/P2Q1PPP/3R1RK1 b - - 2 2"
                        candidate-moves-attack-pinned-piece
                        2)
